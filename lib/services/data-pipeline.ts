...
export const GmbInsightSchema = z.object({
  ...
  mobileSearchImpressions: z.number().min(0),
  desktopMapsImpressions: z.number().min(0),
...
export class DataPipelineService {
  ...
  private sanitizeInsight(insight: any): any {
    return {
      ...
      mobileSearchImpressions: this.sanitizeNumber(insight.mobileSearchImpressions, 0),
      desktopMapsImpressions: this.sanitizeNumber(insight.desktopMapsImpressions, 0),
