            ...
            {analytics.processingStats && (
              <div className="mt-2 p-2 bg-green-50 border border-green-200 rounded-md">
                <p className="text-xs text-green-800">
                  <strong>Analysis Complete:</strong> {analytics.processingStats.processedInThisRun} reviews analyzed in the last {analysisDays} days
                </p>
                <p className="text-xs text-green-600 mt-1">
                  Last updated: {new Date(analytics.processingStats.lastProcessedAt).toLocaleString()}
                </p>
              </div>
            )}
          </CardContent>
